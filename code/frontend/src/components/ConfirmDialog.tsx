...
function ConfirmDialogBody({
  ...
  const confirmClass =
    tone === "danger"
      ? "inline-flex items-center justify-center rounded-2xl bg-rose-400 px-5 py-3 text-sm font-semibold text-slate-950 transition hover:bg-rose-300 disabled:cursor-not-allowed disabled:opacity-50"
      : buttonClass;
      ...
      >
        ...
        {requireText != null ? (
          <label className="mt-4 block text-xs text-slate-400">
            Onaylamak için <strong className="text-white">{requireText}</strong> yazın
            <input
