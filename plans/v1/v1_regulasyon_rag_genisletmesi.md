...
- [ ] İki metni markdown'a çevir → chunk'la → `build_rag.py` ile embed et (upsert: yalnızca yeni chunk'lar embed edilir).
- [ ] PCI DSS özet/eşleme dokümanını yaz → korpusa ekle.
