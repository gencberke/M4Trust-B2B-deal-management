...
> **Child planlar:** `plans/done/00_*.md` … `plans/done/06_*.md` + `plans/done/06X_*.md` (uygulandı) · `plans/ready/07_*.md` … `09_*.md` — her biri bağımsız uygulanabilir, sırası aşağıda.
