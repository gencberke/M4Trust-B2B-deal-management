...
> **Child planlar:** `plans/done/00_*.md`, `plans/done/01_*.md` ve `plans/done/02_*.md` (uygulandı) · `plans/ready/03_*.md` … `09_*.md` — her biri bağımsız uygulanabilir, sırası aşağıda.
